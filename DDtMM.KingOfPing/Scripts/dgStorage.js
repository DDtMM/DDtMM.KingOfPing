// dgStorage by Daniel Gimenez
// version 1.1
// wrapper functions for LocalStorage.  Falls back to cookies if LocalStarage isn't available.
// can save the values of elements, and save those values when the site unloads.
    ...
    function saveElement(elem, key) {
        ...
        switch (elem.nodeName) {
            case 'INPUT':
                ...
                break;
            case 'SELECT':
                // selected options are stored by value not by id since that is rarer
                var selectedOptions = [];
